...
## Copyright @ ThoughtFocus. All Right Reserved.
...
module "labels" {
   ...
   source  = "git::https://dev.azure.com/gcloudvenki231/IaC/_git/terraform//modules/terraform-azure-labels"
    # use git config --global url."https://${azurerepo-pat-token}@dev.azure.com".insteadOf "https://dev.azure.com" to access private repos
